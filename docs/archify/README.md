...
- Repository URL: https://github.com/hundong2/marker.git
- Checkout SHA: d681466eea5da3d089917415d58a9b08834faff2
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: 깨끗한 digital PDF를 CPU에서 빠르게 처리
- Dependency markers: Python, uv
- Top-level directories: benchmarks, data, docs, examples, guide, marker, signatures
- Category: OCR, document, and media AI

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for marker.
